...
- Run [***script merger***](https://www.nexusmods.com/witcher3/mods/484) and merge the scripts if you have other script mods installed. ```Always run script merger to check if any scripts need re-merging after updating from a previous version as well.``` 
