...
state Engage in cTaunt
{
	...
	latent function claw_taunt() 
	{
		...
		watcher.claw_taunt_index = RandDifferent(watcher.previous_claw_taunt_index , 3);

		switch (watcher.claw_taunt_index) 
		{	
			case 2:
			thePlayer.GetRootAnimatedComponent().PlaySlotAnimationAsync ( 'utility_taunt_from_dodge_ACS', 'PLAYER_SLOT', settings);
			break;	
